...
<script>
    ...
    function initializeEventHandlers() {
        ...
        function positionDropdown($button) {
            ...
            $('div.dt-button-collection').remove();
        ...
        $(document).on('click', '.export-btn', function(e) {
            ...
            // Add export options
            var exportOptions = [
                { icon: 'fa-file-csv', text: 'CSV', action: 'csv' },
                { icon: 'fa-file-excel', text: 'Excel', action: 'excel' },
                { icon: 'fa-file-pdf', text: 'PDF', action: 'pdf' },
                { icon: 'fa-print', text: 'Print', action: 'print' }
            ];
            ...
            exportOptions.forEach(function(option) {
                $('<button class="dt-button dropdown-item"></button>')
                    ...
                    .on('click', function() {
                        $container.remove();
                        table.button('.' + option.action + ':first').trigger();
                    })
                    .appendTo($dropdown);
            });
